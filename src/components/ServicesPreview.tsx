  ...
  return (
    <section id="services" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-0 w-64 h-64 bg-accent/5 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-1/4 right-0 w-72 h-72 bg-highlight/5 rounded-full blur-3xl animate-float-slow delay-200" />
      </div>
              ...
              <div
                className={`relative rounded-2xl p-6 h-full transition-all duration-300 hover:-translate-y-2 ${
                  service.highlighted
                    ...
                    : "bg-off-white border border-gray-100 hover:shadow-xl hover:border-accent/20"
                }`}
              >
                {service.highlighted && (
